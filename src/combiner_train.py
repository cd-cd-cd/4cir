...
if __name__ == '__main__':
    ...
    # BLIP pretrain
    parser.add_argument("--blip-pretrained-path", default='/amax/home/chendian/Bi-Blip4CIR-main/models/model_base.pth', type=str, help="path of the BLIP pretrained model weights")
    parser.add_argument("--med-config-path", default='/amax/home/chendian/Bi-Blip4CIR-main/src/blip_modules/med_config.json', type=str, help="path of the BLIP text encoder med_config.json")
    # training args
